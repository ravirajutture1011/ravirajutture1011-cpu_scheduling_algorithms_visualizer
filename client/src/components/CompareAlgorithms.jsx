...
//       // console.log("Stored Process : ", stored);
...
//         ? prevSelected.filter((item) => item !== id) // unselect if already selected
//         : [...prevSelected, id]; // add if not selected

//       // Update localStorage immediately
//       localStorage.setItem("selectedAlgorithms", JSON.stringify(newSelected));
//       return newSelected;
//     });
//   };

//   // Additional useEffect to handle cases where localStorage might be modified externally
//   useEffect(() => {
//     const handleStorageChange = () => {
//       const stored = localStorage.getItem("selectedAlgorithms");
//       if (stored) {
//         setSelectedAlgorithms(JSON.parse(stored));
//       }
//     };
...
//   useEffect(() => {
//     const handleProcessesUpdate = (e) => {
//       setProcesses(e.detail.processes);
//     };

//     window.addEventListener("processesUpdated", handleProcessesUpdate);
//     return () =>
//       window.removeEventListener("processesUpdated", handleProcessesUpdate);
//   }, []);

   

//   const runCompare = async () => {
//     // console.log("running comapre ");
//     const result = [];

//     for (let i = 0; i < selectedAlgorithms.length; i++) {
//       let algo = selectedAlgorithms[i];
//       const timeQuantum = 2;
//       // make api call for each algo
...
//       // console.log("priningting selected algorithm", algo);
//       // console.log("response : ", res.data);
//       const averageWaitingTime = res.data.averageWaitingTime;
//       const averageTurnaroundTime = res.data.averageTurnaroundTime;
...
//   useEffect(() => {
//     if (algorithmsData && compareReff.current) {
...
//             Configure processes, select algorithms, and compare performance
//             metrics.
//           </p>
//         </motion.div>
//       </div>
...
//       {/* <ProcessForm isCompare={true} compare={compare}  setCompare={setCompare} /> */}
...
//               Number of process entered : {processes.length}
//             </strong>
//           </div>
//         )} */}
//       </div>
...
//           className="bg-green-600 p-2 ml-9 rounded-2xl cursor-pointer  disabled:bg-gray-400 "
//           onClick={runCompare}
//         >
//           Compare
//         </button>
...
//         className={`
//     p-2 ml-9 rounded-2xl cursor-pointer
//     ${
...
//             const algoLabel =
//               algorithmsList.find((item) => item.id === algorithm.algo)
...
//                 <div
//                   key={algorithm.algo}
//                   className="bg-gradient-to-br from-gray-800 to-gray-900 text-white rounded-xl shadow-lg p-5 hover:shadow-2xl transition duration-300"
//                 >
